...
const objectCounter = (obj) => {
    ...
    let initialValue=0;
    return obj.reduce((acc=0,initialValue,index)=>index+1)
}
// -------------------------------------------------------------------------------------------------------
...
const stringReverse = (str) => {
    // write your code here
    str=str.split(" ");
    let initialValue=str[str.length-1]
   return str.reduce((acc=str[str.length-2],initialValue)=>initialValue+" "+acc)
